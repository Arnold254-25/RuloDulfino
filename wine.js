...
const addToCart = (product_id) => {
    let positioThisProductInCart = carts.findIndex((value)=> value.product_id == product_id);
if(carts.length <= 0) {
    carts = [{
...
else if(positioThisProductInCart < 0){
    carts.push({
        product_id:product_id,
        quantity: 1
    });
        ...
        carts[positioThisProductInCart].quantity = carts[positioThisProductInCart].quantity + 1;
    }
addCartToHTML ();
addCartToMemory();
